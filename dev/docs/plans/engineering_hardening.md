...
| [d — Capability interfaces](engineering_hardening_d_capability_interfaces.implementation_spec.md)                    | Phases receive narrow subsystem handles instead of `World`; facade growth stops                   | b; independent of c                                                  | d1 done (surface + WorldView); d2–d4 pending     |
