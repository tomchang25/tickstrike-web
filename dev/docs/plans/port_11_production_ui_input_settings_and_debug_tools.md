...
| Child                             | Scope                                                                                                                                                                                                                                                                                                    | Handoff                                                                                              |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| 01 e2e spec split                 | Split `test/e2e/testbed.spec.ts` into focused specs (harness/lifecycle, per-enemy behavior, input/UI groups); pure moves, no assertion change                                                                                                                                                            | [port_11_01_e2e_spec_split.implementation_spec.md](port_11_01_e2e_spec_split.implementation_spec.md) |
| 02 Windup cancel core and runtime | Core resolver clearing the armed Smash without consuming time plus a `smash_cancelled` event; runtime `cancelArmedSmash` entrance through the serialized queue; command-log entry kind; debug API; unit tests. Goldens must pass unregenerated                                                           | [port_11_02_windup_cancel.implementation_spec.md](port_11_02_windup_cancel.implementation_spec.md)   |
