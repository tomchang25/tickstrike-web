...
This directory is the entry point for Tickstrike Web development governance, documentation, and tooling.

- `foundation/` contains the pinned shared game-devkit; do not edit it from this project.
