...
- [port_11_shell] Put production HUD, input, settings, and debug controls around the same runtime; children 01-04 shipped, child 05 remains - [ref plans/port_11_production_ui_input_settings_and_debug_tools.md]
