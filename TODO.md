...
- [port_11_shell] Put production HUD, input, settings, and debug controls around the same runtime; children 01-02 shipped, children 03-05 remain - [ref plans/port_11_production_ui_input_settings_and_debug_tools.md]
